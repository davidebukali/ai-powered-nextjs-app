...
-- CreateTable
CREATE TABLE "JournalEntrySections" (
    "id" TEXT NOT NULL,
    "entryId" TEXT NOT NULL,
    "embedding" VECTOR(384),

    CONSTRAINT "JournalEntrySections_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "JournalEntrySections_entryId_idx" ON "JournalEntrySections"("entryId");
